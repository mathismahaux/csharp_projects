// 1. Given the following code snippet, what will the method MultiplyNumbers() return when called with the arguments 3 and 4?
...
// 2. Which of the following options represents the correct way to declare and assign a string variable?
...
// Answer: string MyString = "Hello";


// 3. What is the difference between a void method and a method with a return type?

// A void method can only be used in class libraries.
// A void method always returns a value.
// A void method does not return a value, while a method with a return type returns a specific value.
// A void method  cannot be called from another method.
// A method with a return type can only return numeric values.

// Answer: A void method does not return a value, while a method with a return type returns a specific value.


// 4. How do you convert an integer variable named age to a string?

// string.Parse(age);
// age.ToString("D");
// Convert.ToUInt32(age);
// Convert.ToString(age);
// AesGcm.ToString();

// Answer: Convert.ToString(age);


// 5. How do you add a single-line comment in C#?
...
// 6. Which data type would you use to store a large whole number?
...
// Variable, increment and condition
// Start, end and step
// Counter, increment and condition
// Initialization, increment and body
// Initialization, condition and final expression

// Answer: Variable, increment and condition


// 8. How do you resume program execution after hitting a breakpoint in VS Code?
...
// 9. What is the syntax to return a value from a method?
...
// My name is Alice and I'm 25 years.
